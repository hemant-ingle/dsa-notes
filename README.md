...
| 18. | [Sort Colors](https://leetcode.com/problems/sort-colors/description/) | **LeetCode** | `Two Pointers` | **Dutch National Flag Algorithm / Three-Way  Partitioning** | Partition into `< mid`, `= mid`, and `> mid` in one pass using three pointers. | [Wikipedia](https://en.wikipedia.org/wiki/Dutch_national_flag_problem) | [:link:](dutch_national_flag_algorithm/notes.md) | 🟡 Review |
| 19. | [Majority Element](https://leetcode.com/problems/majority-element/description/) | **LeetCode** | `Greedy` | **Boyer-Moore Majority Voting Algorithm** | [Pierre Munhoz's Blog](https://blog.pmunhoz.com/blog/algorithm/boyer-moore-majority-vote/) | Different elements cancel each other; since the majority has more than half the votes, it cannot be completely cancelled and survives as the final candidate. | [:link:](boyer_moore_majority_voting_algorithm/notes.md) | 🟡 Review | 