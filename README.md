...
| 19. | [Majority Element](https://leetcode.com/problems/majority-element/description/) | **LeetCode** | `Greedy` | **Boyer-Moore Majority Voting Algorithm** | Different elements cancel each other; the majority survives. | [Pierre Munhoz's Blog](https://blog.pmunhoz.com/blog/algorithm/boyer-moore-majority-vote/) | [:link:](boyer_moore_majority_voting_algorithm/notes.md) | 🟡 Review | 